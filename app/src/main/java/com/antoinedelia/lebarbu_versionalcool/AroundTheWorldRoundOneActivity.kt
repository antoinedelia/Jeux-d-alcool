...
class AroundTheWorldRoundOneActivity : androidx.appcompat.app.AppCompatActivity() {
    ...
    private fun setupCardClick(
        ...
        imageViewCard: android.widget.ImageView?,
        layoutToHide: LinearLayout?,
        sipTypeResId: Int
    ) {
        imageView?.setOnClickListener { v ->
            if (android.os.SystemClock.elapsedRealtime() - lastClickTime < DELAY_TIME) return@setOnClickListener
            ...
            imageViewCard?.let { Picasso.with(this).load(resourceId).into(it) }

            listPlayers!![numberActualPlayer]!!.getCards()[round] = card
            refreshCards()

            if (imageView.isInvisible) return@setOnClickListener

            findViewById<LinearLayout>(R.id.containerImageCard)?.visibility = android.view.View.VISIBLE
            layoutToHide?.visibility = android.view.View.INVISIBLE
            checkSips(getString(sipTypeResId))
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in 0..<numberPlayers) listPlayers!![i]!!.specialTrait =
            java.util.ArrayList<Player.Trait?>(2)
        ...
        setupCardClick(
            findViewById(R.id.imageViewRed),
            imageViewCard,
            findViewById(R.id.containerImageRedOrBlack),
            R.string.red
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewBlack),
            imageViewCard,
            findViewById(R.id.containerImageRedOrBlack),
            R.string.black
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewLess),
            imageViewCard,
            findViewById(R.id.containerImageMoreOrLess),
            R.string.less
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewMore),
            imageViewCard,
            findViewById(R.id.containerImageMoreOrLess),
            R.string.more
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewEquals1),
            imageViewCard,
            findViewById(R.id.containerImageMoreOrLess),
            R.string.equals
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewBetween),
            imageViewCard,
            findViewById(R.id.containerImageBetweenOrOutside),
            R.string.between
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewOutside),
            imageViewCard,
            findViewById(R.id.containerImageBetweenOrOutside),
            R.string.outside
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewEquals2),
            imageViewCard,
            findViewById(R.id.containerImageBetweenOrOutside),
            R.string.equals
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewSame),
            imageViewCard,
            findViewById(R.id.containerImageSameOrDifferent),
            R.string.same
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewDifferent),
            imageViewCard,
            findViewById(R.id.containerImageSameOrDifferent),
            R.string.different
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewSpades),
            imageViewCard,
            findViewById(R.id.containerImageSuitChoice),
            R.string.spades
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewDiamonds),
            imageViewCard,
            findViewById(R.id.containerImageSuitChoice),
            R.string.diamonds
        )
        ...
        setupCardClick(
            findViewById(R.id.imageViewClubs),
            imageViewCard,
            findViewById(R.id.containerImageSuitChoice),
            R.string.clubs
        )
